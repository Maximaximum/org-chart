// @ts-nocheck
import { Point, HierarchyNode, State } from './d3-org-chart.types';
...
export const defaultAttrs: Partial<State<Datum>> = {
  ...
  hdiagonal: function (s: Point, t: Point, m: Point) {
  ...
  diagonal: function (s: Point, t: Point, m: Point, offsets = { sy: 0 }) {
    const x = s.x;
    let y = s.y;
